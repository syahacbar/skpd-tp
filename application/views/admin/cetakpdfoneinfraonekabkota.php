...
$pdf->SetTitle('DATA LAPORAN PENGADUAN '.$infrastruktur.' '.$kabkota);
...
<div class="heading">DATA PELAPORAN<br>INFRASTRUKTUR '.$infrastruktur.'<br>'.$kabkota.'<br>'.$tanggal.'</div><br>
<table width="100%" border="1" cellpadding="5">
    <tr class="center">
        <th width="30">No.</th>
        <th width="60">Tanggal <br>Pengaduan</th>
        <th width="160">Isi Laporan/<br>Pengaduan</th>
        <th width="90">Nama/<br>Ruas Jalan</th>
        <th width="70">Kec./Distrik</th>
        <th width="70">Titik Lokasi<br>(Koordinat)</th>
        <th width="70">Nama Pelapor/<br>NIK</th>
        <th width="70">No. HP/<br>Email</th>
        <th width="90">Alamat Lengkap<br>(Sesuai KTP)</th>
...
$pdf->Output('DATA LAPORAN PENGADUAN INFRASTRUKTUR '.$infrastruktur.' '.$kabkota.'.pdf', 'I');

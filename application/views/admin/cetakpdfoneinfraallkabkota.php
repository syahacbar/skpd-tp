...
<div class="heading">DATA PELAPORAN<br>INFRASTRUKTUR '.$infrastruktur.'<br>SEMUA KAB/KOTA</div><br>
<table width="100%" border="1" cellpadding="5">
    <tr class="center">
        <th width="30">No.</th>
        <th width="60">Tanggal <br>Pengaduan</th>
        <th width="130">Isi Laporan/<br>Pengaduan</th>
        <th width="70">Nama/<br>Ruas Jalan</th>
        <th width="70">Kab/Kota</th>

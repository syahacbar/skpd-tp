            ...
            <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
              ...
              <div class="d-flex justify-content-center py-4">
                <a href="index.html" class="logo d-flex align-items-center w-auto">
                  ...
                  <span class="d-none d-lg-block">Lupa Kata Sandi</span>
                </a>
              </div><!-- End Logo -->
              ...
              <div class="card mb-3 card-loginpage">
                ...
                <div class="card-body">
                  ...
                  <div class="pt-4 pb-2">
                    ...
                    <p class="text-center small">Silakan isi email Anda pada kolom di bawah ini. Sistem akan mengirimi Anda link atur ulang kata sandi. Jangan lupa cek email Anda.</p>
                  </div>
                  ...
                  <!-- <form class="row g-3 needs-validation" novalidate> -->
                    ...
                    <div class="col-12 mb-4">
                      <label for="identity" class="form-label">Email</label>
                        ...
                        <div class="invalid-feedback">Kolom Email tidak boleh kosong!</div>
                    </div>
